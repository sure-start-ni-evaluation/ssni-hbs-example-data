...
nimats_main_df <-
  ...
  mutate(
    ...
    current_soa_2022 = take_area(seed = 12),# ....
    current_soa_2021 = take_area(seed = 12),# ....
    current_soa_2020 = take_area(seed = 12),# ....
    current_soa_2019 = take_area(seed = 12),# ....
    current_soa_2018 = take_area(seed = 12),# ....
    current_soa_2017 = take_area(seed = 12),# ....
    current_soa_2016 = take_area(seed = 12),# ....
    current_soa_2015 = take_area(seed = 12),# ....
    current_soa_2014 = take_area(seed = 12),# ....
    current_soa_2013 = take_area(seed = 12),# ....
    current_soa_2012 = take_area(seed = 12),# ....
    current_soa_2011 = take_area(seed = 12),# ....
    current_soa_2010 = take_area(seed = 12),# ....
    current_soa_2009 = take_area(seed = 12),# ....
    current_soa_2008 = take_area(seed = 12),# ....
    current_soa_2007 = take_area(seed = 12),# ....
    current_soa_2006 = take_area(seed = 12),# ....
    current_soa_2005 = take_area(seed = 12),# ....
    current_soa_2004 = take_area(seed = 12),# ....
    current_soa_2003 = take_area(seed = 12),# ....
    current_soa_2002 = take_area(seed = 12),# ....
    current_soa_2001 = take_area(seed = 12),# ....
    current_soa_2000 = take_area(seed = 12),# ....
